  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        (!ResponsiveBreakpoints.of(context).isDesktop) ? const Center(child: Expanded(child: ProfilePictureWidget()),) : const SizedBox.shrink(),
        Row(
          children: [
            ...
            (ResponsiveBreakpoints.of(context).isDesktop) ? const ProfilePictureWidget() : const SizedBox.shrink(),
          ],
        ),
      ],
    );
